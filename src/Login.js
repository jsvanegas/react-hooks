...
// We can export directly this function, with arrow functions that is not possible
export default function Login() {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <h2>Login</h2>
      <form style={{ display: 'grid', alignItems: 'center', justifyContent: 'center' }} onSubmit={handleSubmit}>
